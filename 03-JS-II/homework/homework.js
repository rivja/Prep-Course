...
const { getFileIgnores } = require("@11ty/eleventy/src/EleventyFiles")
...
function esPrimo(numero) {
  ...
  for(let prosibleDivisor = 1; prosibleDivisor<=numero; prosibleDivisor++){
    if(numero % prosibleDivisor === 0 ){
...
for(let multiplo= 0; multiplo <= 10; multiplo++ ){
  ...
  console.log("6x" + multiplo + "=" + producto)
